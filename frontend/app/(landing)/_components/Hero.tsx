      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        <div className="text-center lg:text-left">
          ...
          <p className="text-slate-500 text-xl mb-10 leading-relaxed max-w-lg mx-auto lg:mx-0">
            Gentle, reliable medical transportation designed for seniors and children. We make every journey stress-free.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            <button className="bg-prime-red text-white px-10 py-5 rounded-full font-bold text-lg shadow-xl shadow-red-500/30 hover-lift">
              Book a Friendly Ride
            </button>
            <button className="bg-white border-2 border-slate-100 px-10 py-5 rounded-full font-bold text-lg hover:bg-slate-50 transition">
              See Our Cars
            </button>
          </div>
        ...
        <div className="relative">
          ...
          <div className="bg-white p-4 rounded-super soft-shadow rotate-2 overflow-hidden border-4 border-white">
            <div className="bg-slate-50 rounded-4xl h-112.5 flex items-center justify-center text-slate-300 italic">
              <Image src="/pcmticon.png" alt="Hero Icon" width={120} height={120} className="opacity-20" />
            </div>
